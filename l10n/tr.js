OC.L10N.register(
    ...
    {
    "Zulip" : "Zulip",
    "Connect your Zulip account in the settings" : "Ayarlar bölümünden Zulip hesabınızı bağlayın",
    "No unread messages" : "Okunmamış bir ileti yok",
    "No recent messages" : "Son kullanılan bir ileti yok",
    "Failed to load messages" : "İletiler yüklenemedi",
    "Open Zulip inbox" : "Zulip gelen kutusunu aç",
    "Open Zulip feed" : "Zulip akışını aç",
    "Direct message from {name}" : "{name} kullanıcıdan doğrudan ileti",
    ...
    "Show only unread messages in dashboard widget" : "Pano bileşeninde yalnızca okunmamış iletiler görüntülensin",
    "password" : "parola",
